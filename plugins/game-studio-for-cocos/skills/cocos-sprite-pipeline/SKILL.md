...
This skill is 2D-specific. If the request is for 3D characters, meshes, or materials, route back through `../game-studio-for-cocos/SKILL.md`.
...
- Shared frontend context: `../cocos-game-ui-frontend/SKILL.md`
